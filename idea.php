<?php
  ...
  if(strcmp($receipt1,$receipt2) == 0)
  {
    ...
    header("Location:error.php?error=".$error."&link=ideapresentation.html");
  }
  ...
  $query3 = "SELECT receipt1, receipt2 FROM idea WHERE receipt1='$receipt1' OR receipt2 = '$receipt2' OR receipt1='$receipt2' OR receipt2='$receipt1'";
  ...
  if($count3 == 0 )
  {
    if($count1 == 1  && $count2==1 )
    {
      ...
      $usn2=$row2['usn'];
      echo $usn2;
      $query4 = "INSERT INTO idea(receipt1,receipt2,usn1,usn2) VALUES('".$receipt1."','".$receipt2."','".$usn1."','".$usn2."')";
