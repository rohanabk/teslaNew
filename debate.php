<?php
  ...
  if(strcmp($receipt1,$receipt2) == 0)
  {
    ...
    header("Location:error.php?error=".$error."&link=debate.html");
  }
  ...
  $query3 = "SELECT receipt1, receipt2 FROM debate WHERE receipt1='$receipt1' OR receipt2 = '$receipt2' OR receipt1='$receipt2' OR receipt2='$receipt1'";
  ...
  if($count3 == 0 && $temp == 0)
  {
    if($count1 == 1  && $count2==1 )
    {
      $usn1=$row1['usn'];
      $usn2=$row2['usn'];
      $query4 = "INSERT INTO debate(receipt1,receipt2,usn1,usn2) VALUES('".$receipt1."','".$receipt2."','".$usn1."','".$usn2."')";
