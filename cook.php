<?php
  ...
  if(strcmp($receipt1,$receipt2) == 0)
  {
    ...
    header("Location:error.php?error=".$error."&link=cookingcompetition.html");
  }
  ...
  if($count1 == 0 )
  {
    ...
    header("Location:error.php?error=".$error."&link=cookcompetition.html");
  }
  ...
  $query3 = "SELECT receipt1, receipt2 FROM cook WHERE receipt1='$receipt1' OR receipt2 = '$receipt2' OR  receipt1='$receipt2' OR receipt2='$receipt1'";
  ...
  if($count3 == 0  )
  {
    if($count1 == 1  || $count2==1 )
    {
      ...
      if($usn2 == 0 && $receipt2 == 0)
      {
        ...
        $query4 = "INSERT INTO cook(receipt1,usn1) VALUES('".$receipt1."','".$usn1."')";
      ...
      {
        $query4 = "INSERT INTO cook(receipt1,receipt2,usn1,usn2) VALUES('".$receipt1."','".$receipt2."','".$usn1."','".$usn2."')";
